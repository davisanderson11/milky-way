...
public class ChunkBasedGalaxySystem
{
    ...
    public ScientificMilkyWayGenerator.Star GetStarBySeed(long seed)
    {
        ...
        // Generate planetary system with our seed
        var planetarySystemGen = new PlanetarySystemGenerator();
        var planetarySystem = planetarySystemGen.GeneratePlanetarySystem(seed, star.Type, star.Mass, $"Star-{seed}");
        star.PlanetCount = planetarySystem.Planets.Count;
        
        // Check for companions with our seed
        var (isMultiple, companionCount, companions) = MultipleStarSystems.GetCompanionInfo(seed, star.Type);
        star.IsMultiple = isMultiple;
        star.SystemName = MultipleStarSystems.GetSystemName(seed, star.Type);
