...
if exist "%DOTNET_PATH%\csc.exe" (
    ...
    "%DOTNET_PATH%\csc.exe" /out:ScientificMilkyWayConsole.exe ScientificMilkyWayConsole.cs ScientificMilkyWayGenerator.cs GalacticAnalytics.cs GalaxyChunkSystem.cs MultipleStarSystems.cs PlanetarySystemGenerator.cs
    echo.
